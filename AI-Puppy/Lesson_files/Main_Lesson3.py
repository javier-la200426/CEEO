...
for i in range(train_num):
    ...
    ai.add_data('trick1',SENSOR FUNCTION HERE) # ADD SENSOR COMMAND HERE, GET RID OF STRING
    sound.beep(220)
    utime.sleep(0.75)
...
for i in range(train_num):
    ai.wait_for_right_button()
    ai.add_data('trick2',SENSOR FUNCTION HERE) # ADD SENSOR COMMAND HERE, GET RID OF STRING
    sound.beep(220)
    utime.sleep(0.75)
...
while not button.pressed(button.LEFT):
    guess_sensor = # SENSOR FUNCTION HERE
