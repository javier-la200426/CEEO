...
async def on_sensor_info(event):
    ...
    await my_globals.terminal.eval(execute_code, hidden = False) 
    ...
    #port_info_array = await my_globals.terminal.eval(execute_code, hidden = False) 
    port_info_array = my_globals.port_info_jav_arr
